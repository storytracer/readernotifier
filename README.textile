...
Download the current Version 1.12 with **Snow Leopard** support right here:

"Reader_Notifier_1.12.zip":http://cloud.github.com/downloads/canbuffi/readernotifier/Reader_Notifier_1.12.zip
